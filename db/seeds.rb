...
AdminsJoke.create!(
  genre_id: 2,
  introduction: "ツッコミ：そしたらその後に、仕事でミスしたヒロインがバーに行って街角で出会った男性と再会する訳や。\n" + "ツッコミ：あ、君は朝出会った。",
...
AdminsJoke.create!(
  genre_id: 2,
  introduction: "ツッコミ：そしたらその後も何回もバーで出会ってヒロインが相手の男のダンディーさに惹かれていくわけや。\n" + "ツッコミ：やぁ、また会ったね。",
...
AdminsJoke.create!(
  genre_id: 3,
  introduction: "ボケ　　：そんな事よりなんだタバコなんて吸って。\n" + "ツッコミ：ちっ、うっせーな。",
...
AdminsJoke.create!(
  genre_id: 3,
  introduction: 'ツッコミ：そしたらその後に教室で再会すんねんな。',
