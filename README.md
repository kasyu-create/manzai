...
１　問題発見　　　　<br>
お笑いのネタ作りで苦労している友人の手助けをしたい。（自分がネタ作りに苦労した経験もあって）<br><br>
...
これらによって、ボケを選択するだけで漫才の骨組み（ネタ設定と話の展開）が出来るので、ネタ作りがすごく楽になる。<br>
そして、投稿したネタをみんなが見る事が出来る機能も付ければ、もっと多くの人のネタ作りの参考にもなると考え、機能を追加した。<br>
（下記のポートフォリオのURLよりアプリを見て頂けると幸いです。）<br><br>

３　実現力　　　　　<br>
プログラミングによってアプリを作成。
また、このアプリを実現する為には、ネタのテンプレートを作るのが私になるので、私自身がネタ作りに詳しくならないといけない。なので私は、初めてM-1とキングオブコントに出場して、ネタを書く技術を磨き、芸人にもネタの相談を行った。<br><br>

４　提供力　　　　　<br>
ユーザーに提供（30人）＋　現役エンジニアの方々からフィードバック（３名）<br><br>

５　改善力　　　　　<br>
ユーザーと現役エンジニアから指摘頂いた事の修正。
指摘された個数は約50個ほどですが、全て解決しました。
